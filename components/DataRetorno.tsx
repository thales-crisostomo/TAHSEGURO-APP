      ...
      <>
        {e.params == true ?
            <>
                <CalendarList
                    current={new Date()}
                    minDate={route.params.minimumDate}
                    markedDates={marked}
    ...
    return (
        <>
            ...
            <SafeAreaView style={{display: 'flex', flex: 1, backgroundColor: 'white'}}>
                <Header name={'Data retorno'} icon1={<Feather name="chevron-left" size={24} color="white" />} icon2={''} colorText={'white'} color='#FD5266' onPress1={() => navigation.goBack()}/>
